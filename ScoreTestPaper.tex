...
models that require substantial resources and time to fit.

Well-known model selection methods, widely
used across many fields, include comparing
models using likelihood ratio tests (LRTs), AIC values and score
tests. These methods have their own advantages. To compare two models via
...
needs to be fitted. However, gradients from the more complicated model
